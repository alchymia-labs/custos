...
| [15](plans/2026-07/15-plan-14-release-authority-fixes.md) | Plan 14 fixes: exact release digest promotion + domain authority alignment | 🔲 Not started | Plan 14 ✅ | publishing/promoting v0.3.0 | P1: runtime-test candidate digest before stable tag promotion; align domain peer/subject/Vault authority. P3: correct Docker lock/reproducibility statement. |
