...
if TYPE_CHECKING:
    from shared.nautilus.config.filters import FiltersConfig
...
class FilterManager:
    ...
    def initialize(self) -> list[SubscriptionRequest]:
        ...
        # pure business (no nautilus indicator) and stay in shared.filters.
        from shared.filters import CooldownFilter, MTFFilter, TimeFilter
        from shared.nautilus.filters import (
            NautilusAdxFilter,
        ...
        # platform-neutral (shared.filters, no msgspec) so the typed sub-config is
