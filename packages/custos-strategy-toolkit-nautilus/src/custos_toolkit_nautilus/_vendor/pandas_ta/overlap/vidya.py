...
from custos_toolkit_nautilus._vendor.pandas_ta.utils import get_drift, get_offset, verify_series
...
def vidya(close, length=None, drift=None, offset=None, **kwargs):
    ...
    def _cmo(source: Series, n:int , d: int):
        ...
        For some reason: from custos_toolkit_nautilus._vendor.pandas_ta.momentum import cmo causes
        pandas_ta.momentum.coppock to not be able to import it's
        wma like from custos_toolkit_nautilus._vendor.pandas_ta.overlap import wma?
