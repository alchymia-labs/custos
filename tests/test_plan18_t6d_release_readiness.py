...
READY_RECEIPT_PATH = ROOT / "docs/authority/receipts/custos-plan-18-task-6-toolkit-rc-receipt.json"
...
def _prepare(build_root: Path, output_root: Path):
    return prepare_toolkit_rc_release_readiness(
        ...
        contract_asset_index_path=(ROOT / "docs/authority/strategy-contract-assets-v2.json"),
...
def test_pending_contract_is_source_generated_and_has_one_operational_blocker(
    ...
    assert not READY_RECEIPT_PATH.exists()
