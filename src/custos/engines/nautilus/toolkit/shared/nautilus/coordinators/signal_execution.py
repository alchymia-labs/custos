...
from shared.nautilus.event_publisher import make_signal_tag
from shared.nautilus.orders import _CLOSE_INFLIGHT_TIMEOUT_NS
from shared.signals.types import SignalDirection
...
if TYPE_CHECKING:
    ...
    from shared.signals.types import Signal
