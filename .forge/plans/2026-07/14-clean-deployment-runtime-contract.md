...
发布一个单一、完整、开箱即用的 custos 0.3.0 官方镜像，并提供稳定的
...
| `Makefile` | runtime/standalone 验证 target |
| `pyproject.toml` | 版本 0.3.0 |
| `uv.lock` | 版本与依赖 metadata |
| `.github/workflows/release.yml` | 完整 image contract gate |
...
tenant、RFC3339 nanoseconds、payload schema version 与 payload。
...
### Task 6: Release pipeline 与 post-publish runtime gate
...
### Task 7: Hermetic standalone runtime acceptance
...
### Task 8: 0.3.0 文档、版本与 clean-break close-in
...
| T6 release runtime gate | 🔲 | — | — |
| T7 hermetic standalone acceptance | 🔲 | — | — |
| T8 0.3.0 docs/version | 🔲 | — | — |
| T9 close-out | 🔲 | — | — |
