...
| [18](plans/2026-07/18-typed-toolkit-strategy-contracts.md) | typed toolkit + strategy execution ABI + verified artifact consumer | ⏳ In progress (revised 2026-07-14) | revised PS Plan 53; cross-repo ABI requirements review | Crucible Plan 88 + PS Plan 54 + Speculum Plan 01 + Custos Plan 19 receipts | Custos produces the execution ABI/artifact schema and owns the toolkit/local verifier—not StrategyRelease or artifact selection. Runtime address is `deployment_instance_id`; contracts/core stay Python >=3.11, Nautilus extra requires >=3.12; production accepts signed wheels and proves zero-rewrite strategy migration. |
