...
| [16](plans/2026-07/16-local-v030-consumer-readiness.md) | local v0.3.0 consumer readiness: safe deployment IDs + public validate hash + verified local Docker tag | 🔲 Not started | Plan 14 + Plan 15 ✅ | philosophers-stone Plan 49 | Build and verify `custos-runner:v0.3.0` locally; remote GitHub/GHCR/PyPI publication and namespace decision explicitly deferred. |
