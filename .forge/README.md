...
| [18](plans/2026-07/18-typed-toolkit-strategy-contracts.md) | independent typed strategy toolkit + manifest/artifact/runtime contracts | ⏳ In progress | PS Plan 53; Custos `324da6e` | PS Plan 54 + Speculum Plan 01 + Custos Plan 19 receipts | Publish `custos-strategy-toolkit` under `custos_toolkit.*`; strict typing, private pandas-ta, NT 1.230.0, immutable 0.1.0rc1/final. |
| [19](plans/2026-07/19-crucible-command-runner-fact-runtime-convergence.md) | Crucible command + RunnerFact + local runtime convergence | ⏳ In progress | PRE-PLAN `324da6e`; clean landed Crucible producer receipt | Custos 0.4.0; PS Plan 56 acceptance | Harden strict command parsing, provenance, durable reconcile, NT readiness/equity/risk, signed RunnerFact parity and v0.4 release without restoring standalone authority. |
