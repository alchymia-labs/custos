...
| [18](plans/2026-07/18-typed-toolkit-strategy-contracts.md) | typed toolkit + strategy execution ABI + verified artifact consumer | ⏳ In progress (T1-T5 complete; T6a-d local readiness complete at `b5f0449`; T6 external production execution and T7-T9 remain open) | T6 local `make verify` ✅: 550 passed/4 skipped/1 xfailed, 177 formatted, Ruff/generator/authority, extraction 241/241, strict mypy base 0/41 + adapter 0/59 | Protected toolkit RC runner + production Sigstore + remote immutable readback + READY receipt -> PS Plan 54 artifact/BOM -> Crucible Plan 88 StrategyRelease acceptance -> Custos Plan 19 verifier/runtime; no Speculum gate | Custos owns execution ABI, artifact schema, toolkit and local verifier, not StrategyRelease or artifact selection. T6a-d local contract/build/publication/SBOM/lock/provenance/workflow readiness is complete, but T6 and Plan 18 are not Completed. The only external T6 gate is the real protected release-runner execution with production credentials and registration of its verified immutable READY receipt; T7-T9 remain downstream and unclaimed. The legacy PS `build-image.sh` -> Crucible Python lane remains independent compatibility only. |
