...
from shared.nautilus.capital_allocator import CapitalAllocator
from shared.nautilus.coordinators import (
    ConfigSummaryLogger,
    EquityProvider,
...
from shared.nautilus.event_publisher import (
    EventPublisher,
    generate_signal_id,
...
from shared.nautilus.strategy_core import NautilusStrategyCore
from shared.nautilus.trading_config import NautilusTradingStrategyConfig
from shared.nautilus.utils import (
    deep_asdict,
    derive_bar_type,
)
from shared.nautilus.warmup_manager import WarmupManager
from shared.position import PositionSizer
from shared.risk import OrderPriceCalculator, RiskController, RiskManager
from shared.signals.types import Signal, SignalDirection
from shared.warmup import WarmupConfig
...
class NautilusTradingStrategy(NautilusStrategyCore):
    ...
    def _derive_instrument_id_for_pair(self, pair: str) -> InstrumentId:
        ...
        """
        from shared.nautilus.utils import VENUE_MAP
